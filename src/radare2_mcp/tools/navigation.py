...
class NavigationTools:
    ...
    @staticmethod
    async def seek(address: Address, session_id: Optional[str] = None) -> int:
        """
    ...
    @staticmethod
    async def seek_undo(session_id: Optional[str] = None) -> int:
        """
        Undo seek.
        Equivalent to 's-' command.
        """
    ...
    @staticmethod
    async def seek_redo(session_id: Optional[str] = None) -> int:
        """
        Redo seek.
        Equivalent to 's+' command.
        """
    ...
    @staticmethod
    async def get_block_size(session_id: Optional[str] = None) -> int:
        """
    ...
    @staticmethod
    async def seek_to_function(function_name: str, session_id: Optional[str] = None) -> int:
        """
    ...
    @staticmethod
    async def seek_to_string(string_ref: str, session_id: Optional[str] = None) -> int:
        """
    ...
    @staticmethod
    async def seek_history(session_id: Optional[str] = None) -> List[int]:
        """
        Get seek history.
        Equivalent to 's*' command.
        """
    ...
    @staticmethod
    async def seek_to_register(register: str, session_id: Optional[str] = None) -> int:
        """

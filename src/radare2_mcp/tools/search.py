...
class SearchTools:
    ...
    async def search_assembly(
        assembly: str, session_id: Optional[str] = None
    ) -> List[SearchResult]:
        """
    ...
    async def search_magic(
        magic_db: Optional[str] = None, session_id: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    async def get_all_strings(
        min_length: int = 4, session_id: Optional[str] = None
    ) -> List[SearchResult]:
        """
    ...
    async def search_pattern(
        pattern: str, mask: Optional[str] = None, session_id: Optional[str] = None
    ) -> List[SearchResult]:
        """

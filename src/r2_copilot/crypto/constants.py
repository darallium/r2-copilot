"""Cryptographic constants for algorithm detection."""
...
# RC4 Identity S-Box (initial state)
RC4_IDENTITY_SBOX = list(range(256))

# TEA/XTEA Magic Constants
TEA_DELTA = 0x9e3779b9
XTEA_DELTA = 0x9e3779b9

# Blowfish P-array (first 18 elements)
BLOWFISH_P_ARRAY = [
...
CRYPTO_CONSTANTS: Dict[str, Dict] = {
    "AES": {
        "sbox": AES_SBOX,
    ...
    "SHA1": {
        "initial": SHA1_INITIAL,
        "name": "Secure Hash Algorithm 1"
    },
    "SHA256": {
        "initial": SHA256_INITIAL,
    ...
    "RSA": {
        "exponents": RSA_COMMON_EXPONENTS,
    ...
    "RC4": {
        "identity_sbox": RC4_IDENTITY_SBOX,
    ...
    "BLOWFISH": {
        "p_array": BLOWFISH_P_ARRAY,
        "name": "Blowfish Cipher"
    },
    "CRC": {
        "polynomials": CRC_POLYNOMIALS,

...
class TestMCPServer:
    ...
    async def test_create_session(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="test_mcp")
    ...
    async def test_list_sessions(self, sample_binary):
        ...
        session1 = await server.create_session(file_path=sample_binary, session_name="mcp1")
        session2 = await server.create_session(file_path=sample_binary, session_name="mcp2")
    ...
    async def test_analyze_all(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="analyze_test")
    ...
    async def test_list_functions(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="func_test")
    ...
    async def test_get_binary_info(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="info_test")
    ...
    async def test_disassemble(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="disasm_test")

        lines = await server.disassemble(count=5, address="0x400078", session_id="disasm_test")
    ...
    async def test_navigation(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="nav_test")
    ...
    async def test_flags(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="flag_test")

        # Create flag
        result = await server.create_flag(
            name="test_flag", address="0x400300", session_id="flag_test"
        )
    ...
    async def test_config(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="config_test")
        ...
        # Set config
        result = await server.set_config("asm.comments", "true", "config_test")
        assert result is True
    ...
    async def test_execute_command(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="cmd_test")

        # Execute a simple command
        result = await server.execute_command("?v 2+2", session_id="cmd_test")
    ...
    async def test_check_security(self, sample_binary):
        ...
        session = await server.create_session(file_path=sample_binary, session_name="sec_test")

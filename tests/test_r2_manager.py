...
from radare2_mcp.models.schemas import R2Session, Architecture
...
class TestR2Manager:
    ...
    def test_list_sessions(self, r2_manager, sample_binary):
        ...
        r2_manager.create_session(
            session_id="test_list1",
            file_path=sample_binary
        )
        r2_manager.create_session(
            session_id="test_list2",
            file_path=sample_binary
        )

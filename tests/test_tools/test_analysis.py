...
class TestAnalysisTools:
    ...
    async def test_analyze_function_at_current(self, test_session):
        ...
        result = await AnalysisTools.analyze_function(
    ...
    async def test_get_function_info(self, test_session):
        ...
        info = await AnalysisTools.get_function_info(
            session_id="test_session"
        )
    ...
    async def test_analyze_data(self, test_session):
        """Test data analysis."""
        result = await AnalysisTools.analyze_data(
            session_id="test_session"
        )
    ...
    async def test_get_xrefs_to(self, test_session):
        ...
        xrefs = await AnalysisTools.get_xrefs_to(
            address=addr,
            session_id="test_session"
        )
    ...
    async def test_get_xrefs_from(self, test_session):
        ...
        addr = Address(value=0x400078)
        xrefs = await AnalysisTools.get_xrefs_from(
            address=addr,
            session_id="test_session"
        )
    ...
    async def test_analyze_opcodes(self, test_session):
        ...
        opcodes = await AnalysisTools.analyze_opcodes(
            count=5,
            session_id="test_session"
        )
    ...
    async def test_undefine_function(self, test_session):
        ...
        await AnalysisTools.define_function(
            address=addr,
            size=20,
            session_id="test_session"
        )
        ...
        # Then undefine it
        result = await AnalysisTools.undefine_function(
            address=addr,
            session_id="test_session"
        )

...
class TestWriteTools:
    ...
    async def test_get_debruijn_offset(self, write_session):
        ...
        offset = await WriteTools.get_debruijn_offset(
            pattern="AAAA",
            session_id="write_test"
        )

...
from radare2_mcp.models.schemas import SectionInfo, SymbolInfo, StringInfo
...
class TestBinaryInfoTools:
    ...
    async def test_get_imports(self, test_session):
        ...
        symbols = await BinaryInfoTools.get_symbols(
            imports_only=True,
